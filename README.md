...
- The ultimate free chess platform to improve your games and boost your rating. It imports your games from [lichess.org](https://lichess.org/) and [chess.com](https://www.chess.com/) through their public APIs, so you can analyze what you actually played. The main tools of the project are game analysis, puzzles generated from your own matches, bots to play against, advanced statistics, and opponent preparation and much more. Everything is supported by Coach Moji, an interactive coach that explains why a move was good or bad, and gives hints when you get stuck, of course 18 languages.
...
[bi-kab](https://github.com/staifmatej/bi-kab/blob/main/academic-notes/quantum-key-distribution_staifmatej.pdf) (May 2026) Summary notes prepared for a voluntary discussion on quantum key distribution from Cryptography and Security (BI-KAB) course at CTU FIT. I created this document to synthesize scientific papers on the BB84 and E91 protocols and to successfully defend the topic with the instructor.
